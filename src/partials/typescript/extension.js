...
const tsRules_extension_nonTypeCheck = {
  ...
  '@typescript-eslint/no-invalid-this':
    coreRules_extensibleShared['no-invalid-this'],
  ...
  '@typescript-eslint/func-call-spacing':
    coreRules_extensibleWithTs_nonTypeCheck['func-call-spacing'],
  /**
  ...
  '@typescript-eslint/no-array-constructor':
    coreRules_extensibleWithTs_nonTypeCheck['no-array-constructor'],
  // ts(2300), ts(2393)
  ...
  '@typescript-eslint/no-empty-function': [
    ...
    {
      allow: [
        ...coreRules_extensibleWithTs_nonTypeCheck['no-empty-function'][1]
          .allow,
        'decoratedFunctions',
      ],
    },
  ...
  '@typescript-eslint/no-extra-parens':
    coreRules_extensibleWithTs_nonTypeCheck['no-extra-parens'],
  '@typescript-eslint/no-extra-semi':
    coreRules_extensibleWithTs_nonTypeCheck['no-extra-semi'],
  '@typescript-eslint/no-loop-func':
    coreRules_extensibleWithTs_nonTypeCheck['no-loop-func'],
  '@typescript-eslint/no-loss-of-precision':
    coreRules_extensibleWithTs_nonTypeCheck['no-loss-of-precision'],
  '@typescript-eslint/no-magic-numbers':
    coreRules_extensibleWithTs_nonTypeCheck['no-magic-numbers'],
  // ts(2451)
  ...
  '@typescript-eslint/padding-line-between-statements':
    coreRules_extensibleWithTs_nonTypeCheck['padding-line-between-statements'],
  '@typescript-eslint/quotes':
    coreRules_extensibleWithTs_nonTypeCheck['quotes'],
  '@typescript-eslint/space-before-blocks':
    coreRules_extensibleWithTs_nonTypeCheck['space-before-blocks'],
  '@typescript-eslint/space-before-function-paren':
    coreRules_extensibleWithTs_nonTypeCheck['space-before-function-paren'],
  '@typescript-eslint/space-infix-ops':
    coreRules_extensibleWithTs_nonTypeCheck['space-infix-ops'],
};

const tsRules_extension_nonTypeCheck_OFF = getDisabledRuleSet(
  tsRules_extension_nonTypeCheck,
);

const tsRules_extension_typeCheckOnly = {
  '@typescript-eslint/dot-notation':
    coreRules_extensibleWithTs_typeCheckOnly['dot-notation'],
  '@typescript-eslint/no-implied-eval':
    coreRules_extensibleWithTs_typeCheckOnly['no-implied-eval'],
  ...
  '@typescript-eslint/require-await':
    coreRules_extensibleWithTs_typeCheckOnly['require-await'],
...
const tsRules_extension_typeCheckOnly_OFF = getDisabledRuleSet(
